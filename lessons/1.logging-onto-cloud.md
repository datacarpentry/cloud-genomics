...
2. Ensure that you're in the Northern Virginia availability zone.  Your current availability zone, which is the physical location where your computer will be launched, is listed in the upper right corner of your screen next to "Support".  If something other than "N. Virginia" is listed, click on the availability zone to change it. Otherwise you will be unable to find the Data Carpentry image used in this lesson.
