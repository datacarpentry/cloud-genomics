...
3. In 'Step 1' you will be asked to choose an Amazon Machine Image (AMI), on the lefthand side, look for 'Community AMIs' and then search for **ami-5bc63136**; select this image. The name is "data_carpentry_genomics_20160523 - ami-5bc63136" rather than the one in the image file.
